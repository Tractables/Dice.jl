...
webppl benchmarks/multimodal/multimodal.wppl -- --s $((2**20)) --m MCMC >> benchmarks/multimodal/result1MCMC.txt
webppl benchmarks/multimodal/multimodal.wppl -- --s $((2**20)) --m MCMC >> benchmarks/multimodal/result2MCMC.txt
webppl benchmarks/multimodal/multimodal.wppl -- --s $((2**16)) --m SMC >> benchmarks/multimodal/result1SMC.txt
