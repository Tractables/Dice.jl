...
function timeseries(p::Int, binbits::Int)
    code = @dice begin
        ...
        for i = 1:length(y) - 1
            termg[i] = add_bits(continuous(dicecontext(), p, t, Normal(0, 0.5), 0), binbits + 4, 0)
        end
