...
timeout $2s ../.julia/dev/Dice.jl/baselines/stan/$1/$1 sample num_warmup=1000 num_samples=1000000000 data file=../.julia/dev/Dice.jl/baselines/stan/$1/$1.data.R output file=../.julia/dev/Dice.jl/baselines/stan/$1/$1.csv
