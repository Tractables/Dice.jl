...
Definition manual_gen_tree :=
    ...
    (let
       fix arb_aux (size : nat) (parent_color : Color) : G Tree :=
         ...
         | R =>
          get [
            (1, 500); (2, 500); (3, 500); (4, 500); (5, 500); (6, 500); (7, 476)
          ] s 0
         | B =>
          get [
            (1, 500); (2, 500); (3, 500); (4, 500); (5, 500); (6, 517); (7, 994); (8, 204)
          ] s 0
         end in
         let weight_leaf := match parent_color with 
         | R =>
          get [
            (1, 500); (2, 500); (3, 500); (4, 500); (5, 534); (6, 997); (7, 989)
          ] s 0
         | B =>
          get [
            (1, 500); (2, 500); (3, 500); (4, 500); (5, 500); (6, 585); (7, 509); (8, 167)
          ] s 0
         end in
         match size with
         | 0 => returnGen E
