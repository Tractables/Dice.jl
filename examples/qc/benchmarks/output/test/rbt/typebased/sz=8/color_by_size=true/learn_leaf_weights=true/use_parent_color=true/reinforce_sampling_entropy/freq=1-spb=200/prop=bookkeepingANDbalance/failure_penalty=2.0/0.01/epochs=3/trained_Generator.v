...
Definition manual_gen_tree :=
    ...
    (let
       fix arb_aux (size : nat) (parent_color : Color) : G Tree :=
         ...
         | R =>
          get [
            (1, 494); (2, 485); (3, 494); (4, 492); (5, 510); (6, 499); (7, 499)
          ] s 0
         | B =>
          get [
            (1, 516); (2, 501); (3, 502); (4, 503); (5, 506); (6, 506); (7, 504); (8, 506)
          ] s 0
         end in
         let weight_leaf := match parent_color with 
         | R =>
          get [
            (1, 500); (2, 487); (3, 486); (4, 472); (5, 475); (6, 471); (7, 460)
          ] s 0
         | B =>
          get [
            (1, 503); (2, 491); (3, 498); (4, 490); (5, 478); (6, 465); (7, 477); (8, 436)
          ] s 0
         end in
         match size with
         | 0 => returnGen E
